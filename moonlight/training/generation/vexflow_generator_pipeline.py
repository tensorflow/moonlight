...
flags.DEFINE_integer(
    'num_shards', None, 'Fixed number of shards (optional)')
flags.DEFINE_multi_string('vexflow_generator_command', [
    '/usr/bin/env', 'node', 'vexflow_generator.js',
...
flags.DEFINE_multi_string('svg_to_png_command', [
    '/usr/bin/env',
    'convert',
    'svg:-',
    'png:-',
...
def main(_):
  with pipeline_flags.create_pipeline() as pipeline:
    num_pages = (
        FLAGS.num_positive_examples + generation.POSITIVE_EXAMPLES_PER_IMAGE - 1
